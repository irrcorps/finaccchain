...
--
-- CLOUD/PRODUCTION VARIANT (e.g. TiDB Cloud Starter): unlike database/schema.sql,
-- this file does NOT run DROP/CREATE DATABASE - create the database yourself
-- in the TiDB Cloud console first (utf8mb4 is its default charset), then run
-- this file against it, e.g.:
--   mysql --comments -h <HOST> -P 4000 -u <USER> -p --ssl-mode=REQUIRED \
--         -D <DATABASE> < database/production_schema.sql
-- =====================================================================
